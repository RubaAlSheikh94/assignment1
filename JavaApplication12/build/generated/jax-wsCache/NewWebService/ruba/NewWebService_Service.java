 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://ruba/", wsdlLocation = "http://localhost:13053/ruba/NewWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://ruba/", "NewWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:13053/ruba/NewWebService?wsdl");
    ...
    public NewWebService getNewWebServicePort() {
        return super.getPort(new QName("http://ruba/", "NewWebServicePort"), NewWebService.class);
    }
    ...
    public NewWebService getNewWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ruba/", "NewWebServicePort"), NewWebService.class, features);
    }
